...
class Movies extends Component {
  ...
  <tbody>
    ...
    <tr id='row1'>
      <td id='n1'>{(this.state.arrFather.length)-(this.state.arrFather.length-1)}</td>
      <td>{this.state.arrFather[0][1]}</td>
      <td>{this.state.arrFather[0][2]}</td>
      <td>{this.state.arrFather[0][3]}</td>
      <td><button className='btn btn-danger' onClick={this.r1}>delete</button></td>
      <td><button className='btn btn-warning' onClick={this.r1p}>Patch</button></td>
      
    </tr>
    <tr id='row2'>
      <td>{(this.state.arrFather.length)-(this.state.arrFather.length-2)}</td>
      <td>{this.state.arrFather[1][1]}</td>
      <td>{this.state.arrFather[1][2]}</td>
      <td>{this.state.arrFather[1][3]}</td>
      <td><button className='btn btn-danger' onClick={this.r2}>delete</button></td>
      <td><button className='btn btn-warning' onClick={this.r2p}>Patch</button></td>
    </tr>
    <tr id='row3'>
      ...
      <td><button className='btn btn-danger' onClick={this.r3}>delete</button></td>
      <td><button className='btn btn-warning' onClick={this.r3p}>Patch</button></td>
    </tr>
    <tr id='row4'>
      ...
      <td><button className='btn btn-danger' onClick={this.r4}>delete</button></td>
      <td><button className='btn btn-warning' onClick={this.r4p}>Patch</button></td>
    </tr>
